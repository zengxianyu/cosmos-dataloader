...
import cosmos_datasets.webdataset_base.webdataset
...
def get_world_size() -> int:
    ...
    # If not using distributed training, return 1
    return 1
...
class DataLoader(webdataset.WebLoader):
    ...
    len function is needed.
    """

    def __init__(self, dataset, batch_size: int = 1, *args, **kw):  # Dataset type from cosmos_datasets.webdataset
        ...
        # Get world size for distributed training support
